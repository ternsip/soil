...
public class GLInfo {
    ...
    public static void logBufferInfo() {
        ...
        log.info("Draw buffer: {}", glGetInteger(GL_DRAW_BUFFER0));
    ...
    public static void logComputeLimits() {
        ...
        log.info("Max compute work group count: {}", glGetVector3iIndexed(GL_MAX_COMPUTE_WORK_GROUP_COUNT));
        ...
        log.info("Max compute work group size: {}", glGetVector3iIndexed(GL_MAX_COMPUTE_WORK_GROUP_SIZE));
    }
    ...
    public static void logInfo() {
        ...
        log.info("Number of compressed texture formats: {}", glGetInteger(GL_NUM_COMPRESSED_TEXTURE_FORMATS));
        ...
        log.info("Compressed texture formats: {}", glGetArray(GL_COMPRESSED_TEXTURE_FORMATS, glGetInteger(GL_NUM_COMPRESSED_TEXTURE_FORMATS)));
        ...
        log.info("Major version: {}", glGetInteger(GL_MAJOR_VERSION));
        ...
        log.info("Max array texture layers: {}", glGetInteger(GL_MAX_ARRAY_TEXTURE_LAYERS));

        // data returns one value, the maximum number of application-defined clipping distances. The value must be at least 8.
        log.info("Max clip distances: {}", glGetInteger(GL_MAX_CLIP_DISTANCES));

        // data returns one value, the maximum number of samples in a color multisample texture.
        log.info("Max color texture samples: {}", glGetInteger(GL_MAX_COLOR_TEXTURE_SAMPLES));

        // data returns a single value, the maximum number of atomic counters available to all active shaders.
        log.info("Max combined atomic counters: {}", glGetInteger(GL_MAX_COMBINED_ATOMIC_COUNTERS));
        ...
        log.info("Max combined fragment uniform components: {}", glGetInteger(GL_MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS));
        ...
        log.info("Max combined geometry uniform components: {}", glGetInteger(GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS));
        ...
        log.info("Max combined uniform blocks: {}", glGetInteger(GL_MAX_COMBINED_UNIFORM_BLOCKS));
        ...
        log.info("Max combined vertex uniform components: {}", glGetInteger(GL_MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS));
        ...
        log.info("Max depth texture samples: {}", glGetInteger(GL_MAX_DEPTH_TEXTURE_SAMPLES));
        ...
        log.info("Max draw buffers: {}", glGetInteger(GL_MAX_DRAW_BUFFERS));
        ...
        log.info("Max fragment input components: {}", glGetInteger(GL_MAX_FRAGMENT_INPUT_COMPONENTS));
        ...
        log.info("Max fragment uniform components: {}", glGetInteger(GL_MAX_FRAGMENT_UNIFORM_COMPONENTS));
        ...
        log.info("Max fragment uniform vectors: {}", glGetInteger(GL_MAX_FRAGMENT_UNIFORM_VECTORS));
        ...
        log.info("Max fragment uniform blocks : {}", glGetInteger(GL_MAX_FRAGMENT_UNIFORM_BLOCKS));
        ...
        log.info("Max framebuffer width: {}", glGetInteger(GL_MAX_FRAMEBUFFER_WIDTH));
        ...
        log.info("Max framebuffer height: {}", glGetInteger(GL_MAX_FRAMEBUFFER_HEIGHT));
        ...
        log.info("Max framebuffer layers: {}", glGetInteger(GL_MAX_FRAMEBUFFER_LAYERS));
        ...
        log.info("Max geometry output components: {}", glGetInteger(GL_MAX_GEOMETRY_OUTPUT_COMPONENTS));
        ...
        log.info("Max geometry uniform blocks: {}", glGetInteger(GL_MAX_GEOMETRY_UNIFORM_BLOCKS));
        ...
        log.info("Max geometry uniform components: {}", glGetInteger(GL_MAX_GEOMETRY_UNIFORM_COMPONENTS));

        // data returns one value, the maximum number of samples supported in integer format multisample buffers.
        log.info("Max integer samples: {}", glGetInteger(GL_MAX_INTEGER_SAMPLES));
        ...
        log.info("Min map buffer alignment: {}", glGetInteger(GL_MIN_MAP_BUFFER_ALIGNMENT));
        ...
        log.info("Max label length: {}", glGetInteger(GL_MAX_LABEL_LENGTH));

        // data returns one value, the maximum texel offset allowed in a texture lookup, which must be at least 7.
        log.info("Max program texel offset: {}", glGetInteger(GL_MAX_PROGRAM_TEXEL_OFFSET));

        // data returns one value, the minimum texel offset allowed in a texture lookup, which must be at most -8.
        log.info("Min program texel offset: {}", glGetInteger(GL_MIN_PROGRAM_TEXEL_OFFSET));
        ...
        log.info("Max rectangle texture size: {}", glGetInteger(GL_MAX_RECTANGLE_TEXTURE_SIZE));

        // data returns one value. The value indicates the maximum supported size for renderbuffers. See glFramebufferRenderbuffer.
        log.info("Max render buffer size: {}", glGetInteger(GL_MAX_RENDERBUFFER_SIZE));

        // data returns one value, the maximum number of sample mask words.
        log.info("Max samples mask words: {}", glGetInteger(GL_MAX_SAMPLE_MASK_WORDS));

        // data returns one value, the maximum glWaitSync timeout interval.
        log.info("Max server wait timeout: {}", glGetInteger(GL_MAX_SERVER_WAIT_TIMEOUT));
        ...
        log.info("Max shader storage buffer bindings: {}", glGetInteger(GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS));

        // data returns a single value, the maximum number of atomic counters available to tessellation control shaders.
        log.info("Max tess control atomic counters: {}", glGetInteger(GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS));

        // data returns a single value, the maximum number of atomic counters available to tessellation evaluation shaders.
        log.info("Max tess evaluation atomic counters: {}", glGetInteger(GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS));
        ...
        log.info("Max tess control shader storage blocks: {}", glGetInteger(GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS));
        ...
        log.info("Max tess evaluation shader storage blocks: {}", glGetInteger(GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS));
        ...
        log.info("Max texture buffer size: {}", glGetInteger(GL_MAX_TEXTURE_BUFFER_SIZE));
        ...
        log.info("Max texture LOD bias: {}", glGetInteger(GL_MAX_TEXTURE_LOD_BIAS));
        ...
        log.info("Max varying vectors: {}", glGetInteger(GL_MAX_VARYING_VECTORS));
        ...
        log.info("Max varying floats: {}", glGetInteger(GL_MAX_VARYING_FLOATS));

        // data returns a single value, the maximum number of atomic counters available to vertex shaders.
        log.info("Max vertex atomic counters: {}", glGetInteger(GL_MAX_VERTEX_ATOMIC_COUNTERS));
        ...
        log.info("Max vertex shader storage blocks: {}", glGetInteger(GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS));
        ...
        log.info("Max vertex uniform components: {}", glGetInteger(GL_MAX_VERTEX_UNIFORM_COMPONENTS));
        ...
        log.info("Max vertex uniform vectors: {}", glGetInteger(GL_MAX_VERTEX_UNIFORM_VECTORS));

        // data returns one value, the maximum number of components of output written by a vertex shader, which must be at least 64.
        log.info("Max vertex output components: {}", glGetInteger(GL_MAX_VERTEX_OUTPUT_COMPONENTS));
        ...
        log.info("Max vertex uniform blocks: {}", glGetInteger(GL_MAX_VERTEX_UNIFORM_BLOCKS));
        ...
        log.info("Max viewport dimensions: {}", glGetVector2i(GL_MAX_VIEWPORT_DIMS).toString(NUMBER_FORMAT_INT));
        ...
        log.info("Number of extensions: {}", glGetInteger(GL_NUM_EXTENSIONS));

        // data returns one value, the number of program binary formats supported by the implementation.
        log.info("Number of program binary formats: {}", glGetInteger(GL_NUM_PROGRAM_BINARY_FORMATS));
